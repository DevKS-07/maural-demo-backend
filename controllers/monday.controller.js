...
const callbackHandler = async (req, res) => {
  ...
  try {
    ...
    await prisma.mondayToken.upsert({
      where:  { user_id },
      create: { user_id, access_token, refresh_token: refresh_token ?? null, expires_in: expires_in ?? null },
      update: { access_token, refresh_token: refresh_token ?? null, expires_in: expires_in ?? null },
    });
